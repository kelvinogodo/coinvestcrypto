...
<head>
    ...
    <link rel="stylesheet" href="{{asset('web/css files/about.css')}}">
...
<body>
    ...
    <header id="head">
        ...
        <div class="menu-list" id="menu-items">
         ...
         <ul class="list-items">
            <li><a href="{{asset('index')}}">home <img src="{{asset('/images/arrow-24-xxl.png')}}" alt="" class="arrow"> </a ></li>
             <li><a href="{{asset('contact')}}">contact  <img src="{{asset('/images/arrow-24-xxl.png')}}" alt="" class="arrow"></a></li>
              <li><a href="{{asset('blog')}}">blog  <img src="{{asset('/images/arrow-24-xxl.png')}}" alt="" class="arrow"></a></li>
             <li><a href="{{asset('about')}}">about <img src="{{asset('/images/arrow-24-xxl.png')}}" alt="" class="arrow"></a></li>
             <li><a href="{{asset('how-it-works')}}">how it works  <img src="{{asset('/images/arrow-24-xxl.png')}}" alt="" class="arrow"></a></li>
         </ul>
        </div>
...
<section class="about-landpage">
    <img src="{{asset('/images/4380.jpg')}}" alt="" class="about-landpage-img">
</section>
...
<section class="our-vision-section">
    <img src="{{asset('/images/2164477.jpg')}}" alt="" class="vision-img">
...
<section class="our-team-section">
    ...
    <div class="our-team-img">
        <img src="{{asset('/images/4776016.jpg')}}" alt="" class="our-img">
    </div>
</section>
<div class="team-card-container">
    <div class="team-card">
        <img src="{{asset('/images/1000_F_261258321_GP0Q6btipSzYzOQYQCvM8xzbU78jebdk.jpg')}}" alt="" class="profile-img">
