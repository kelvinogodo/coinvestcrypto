...
<!-- end of the header section -->
    <section class="contact-landpage">
        <div class="landpage-img">
            <img src="{{asset('/images/195-removebg-preview.png')}}" alt="">
        </div>
    ...
    <section class="get-in-touch-section">
        ...
        <div class="get-in-touch-img-container">
            <img src="{{asset('/images/live-chat-with-customer-service-vector-illustration_7087-1844.jpg')}}" alt="" class="get-in-touch-img">
        </div>
    ...
    <div class="social-handle">
        ...
        <img src="{{asset('/images/paper-plane.png')}}" alt="" class="social-icon">
    </div>
    <!-- footer section -->
    <footer>
        <!-- first division -->
