...
<head>
    ...
    <link rel="stylesheet" href="{{asset("web/css files/general.css")}}">
    <link rel="stylesheet" href="{{asset("web/css files/how.css")}}">
        ...
        <div class="menu-list" id="menu-items">
         ...
         <ul class="list-items">
            <li><a href="{{route("index")}}">home <img src="{{asset('/images/arrow-24-xxl.png')}}" alt="" class="arrow"> </a ></li>
             ...
             <li><a href="{{route("about")}}">about <img src="{{asset('/images/arrow-24-xxl.pn')}}g" alt="" class="arrow"></a></li>
...
<!-- this is the how it works land page  -->
    <section class="how-landpage">
        <div class="landpage-img">
            <img src="{{asset('/images/business-people-with-balance-scales-bitcoin-vs-dollar-person-trading-buying-crypto-currency-flat-vector-illustration-stock-crypto-market-concept-banner-website-design-landing-web-page_179970-6615.webp')}}" alt="">
        </div>
    ...
    <section class="guide-section">
        ...
        <div class="guide-card">
            ...
            <img src="{{asset('/images/wallet.png')}}" alt="" class="guide-img">
        </div>
        <!-- card 2  -->
        <div class="guide-card ">
            <div class="guide-text">
            ...
            <img src="{{asset('/images/debit-card.png')}}" alt="" class="guide-img">
        </div>
        <!-- card 3 -->
        <div class="guide-card">
            <div class="guide-text">
            ...
            <img src="{{asset('/images/exchange.png')}}" alt="" class="guide-img">
        </div>
    ...
    <div class="img-cont">
        <img src="{{asset('/images/origami-abstract-concept-vector-illustration-art-paper-folding-mental-practice-fine-motor-skills-development-useful-pastime-social-isolation-how-video-tutorial-abstract-metaphor_335657-4128.jpg" alt="" class="good-to-go-img">
